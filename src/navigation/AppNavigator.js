...
function MainTabs() {
  return (
    <Tab.Navigator screenOptions={{
      ...
      <Tab.Screen name="Scanner" component={ScannerScreen} options={{tabBarLabel: 'Scan', tabBarIcon: tabIcons.Scanner}} />
...
function DashboardStackScreen() {
  return (
    <DashboardStack.Navigator screenOptions={screenOptions}>
      ...
      <DashboardStack.Screen name="Posyandu" component={PosyanduScreen} options={{title: 'Posyandu'}} />
      <DashboardStack.Screen name="UserManagement" component={UserManagementScreen} options={{title: 'Manajemen User'}} />
      <DashboardStack.Screen name="IoTDevices" component={IoTDevicesScreen} options={{title: 'Perangkat IoT'}} />
...
function ChildrenStackScreen() {
  return (
    <ChildrenStack.Navigator screenOptions={screenOptions}>
      ...
      <ChildrenStack.Screen name="CreateChild" component={CreateChildScreen} options={{title: 'Tambah Anak'}} />
      <ChildrenStack.Screen name="ChildDetail" component={ChildDetailScreen} options={({route}) => ({title: route.params?.title || 'Detail Anak'})} />
      <ChildrenStack.Screen name="CreateMeasurement" component={CreateMeasurementScreen} options={{title: 'Tambah Pengukuran'}} />
